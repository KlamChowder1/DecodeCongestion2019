...
export class HomePage implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
      ...
      setTimeout(() => {
          ...
          this.markerOptions.title = 'Vlane End';
          this.markerOptions.icon =  { "url" : "http://maps.google.com/mapfiles/ms/icons/yellow-dot.png" };
  ...
  showNewMarker()
  {
    ...
    this.newMarkerOptions.title = 'Vlane Start';   
    this.newMarkerOptions.icon =  { "url" : "http://maps.google.com/mapfiles/ms/icons/green-dot.png" };
